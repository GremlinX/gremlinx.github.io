...
<template>
  ...
  >
    <div class="card-content">
      <span class="project-num">{{ project.featured ? '✦ Projeto Principal' : project.num }}</span>
    ...
    <div v-if="project.featured" class="featured-visual">
      ...
      <span class="featured-label">Produtividade<br>& Finanças</span>
    </div>
  </article>
</template>
...
.project-card:hover .project-desc { color: var(--color-bg); }
...
@media (max-width: 768px) {
  ...
  .project-card.featured {
    grid-column: span 1;        /* ocupa 1 coluna como os outros */
    grid-template-columns: 1fr; /* empilha */
  }

  /* Esconde o visual decorativo no mobile — não cabe */
